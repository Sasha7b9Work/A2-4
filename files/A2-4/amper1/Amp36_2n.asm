...
rebyte:
	...
	jnb	is_cmd,me3		;??
	call	cmd_tree
;	jnb	bitoll,me3		;isn't new
;	jnb	is_rs,me3		;??
;	mov	A,#bufind
;	mov	p_out,A
;	mov	cnt_out,#12
;	mov	SBUF0,cmd_rez	;#21h	-sign need for stream
;+	clr	is_rs		;+if PC timer use
me3:
...
me_5:
 		jnb	is_2,me_6
		call	resa_hl ;enough:	jmp	yesbuf ;?
