...
taktind:		
					...
					call	ind	   ;пп выдачи на индикатор
norvich: 
     				mov		r0,# parT
					mov		r1,#chind
					cjne	@r0,#1,rnot1in
...
;и запись в ячейки коэфф памяти прогр (3000h) 
				...
				call	wrpage
					...
					;загр Т1 в соотв с установленной скоростью
					clr		bitmenu
					setb		bitizm
					jmp			out7

me_41:		cjne		@r0,#41h,labels4
					mov		p3,#0fbh;<-
					jnb		p3.7,rlabelS3
					mov		p3,#0f7h
					jb		p3.7,onmem12
					;сравнить пароль с индикатором
					;равны?
					;режим меню 42
					;0000-n
					jmp		outF
...
rlabelS3:	jmp		labelS3
onmem13:	jmp		outF	;(ie7)

labels4:	cjne		@r0,#42h,onmem13
					mov			p3,#0fbh;<-
					jnb		p3.7,rlabelS3
					mov		p3,#0f7h;vvod
					jb		p3.7,onmem13
					;число на индикаторе ->Ak
					setb		bitklb
					;зажечь KMП
					setb		bitizm
					jmp			outmenu
...
teTESR:	db	" ","T","E",79h,"T",2d,"R","S",32h,33h,32h;ТЕСТ RS232 12
teSKOR:	db	" ",79h,'K',30h,"P"," ",32h,33h,32h," ";СКОР 232      13
