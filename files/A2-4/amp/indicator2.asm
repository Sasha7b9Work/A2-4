...
;поджиг точек  
				mov		a,makoi+11
			 jnb		acc.4,nopoi1
			 anl		bufind+2,#0bfh;точка после 1й знакоместа
			 jmp		nopoin;mov		a,makoi+11
nopoi1:	 jnb		acc.3,nopoin8
				anl		bufind+16,#0bfh;точка после 8й знакоместа
			 jmp		nopoin
nopoin8:
				jnb		acc.5,nopoin7
				anl		bufind+14,#0bfh;точка после 7й знакоместа
				jmp		nopoin
nopoin7:jnb		acc.2,nopoin5
				anl		bufind+10,#0bfh;точка после 5й знакоместа
			jmp		nopoin
nopoin5:jnb		acc.6,nopoin4
				anl		bufind+12,#0bfh;точка после 6й знакоместа
				jmp		nopoin
nopoin4:jnb		acc.7,nopoin
				anl		bufind+8,#0bfh;точка после 4й знакоместа
nopoin:	
