...
;		XSEG AT 100h
	PUBLIC 	  MASS0
MASS0  xdata 0080h;	массив измерения
MASS1  xdata 0084h;
MASS2  xdata 0088h;
MASS3  xdata 008ch;
MASS4  xdata 0090h;
...
;;;;;;;;;;
 gotoKD:		clr		c
			...
			call	loadKD;mov		r0,#koefKD;->r8..r11
			;call	resar8
			call	flmul
			call	ftol			;float->int
			mov		r0,#rez_A1
...
;;;;;;;;;;;;;;
			...
			;	jnc		rmo220		;A>220000
				...
				call	resar2
				call	altof			;r2..r5->float
				call	loadKD;mov		r0,#koefKD		;KD->r8..r11
...
rigblo:		mov		p3,#0fbh
			jb		p3.6,llev2
labL2:	  ; mov		r1,#marker;а  уст курсор в правую позицию 
...
rigblok:	mov		p3,#0fbh  ;32,33,34,42
			jb		p3.6,lev2go
labelN:		mov		r0,#marker	;курсор справа 	?
			mov		a,movrig
			clr		c
			subb	a,@r0
			jnz	   noequ1
			...
			mov		@r0,a
			jmp		outF
noequ1:		call	marri;уст сдвиг в правую	позицию
			jmp		outF
lev2go:		mov		p3,#0fdh
			jnb		p3.6,rlabelL1
			jmp		outF
...
nomarl:			dec		@r0				;нажата кн <- при вводе цифр A=000000
				clr		bitmig
				cjne	@r0,#3,out7
				inc		@r0
...
textT:		
			...
			db		0fdh,"T","=",30h,".",31h,"S",0fdh,0fdh,0fdh
			db		" "," "," ","T","=",31h,"S"," "," "," "
			db		" "," ","T","=",31h,30h,"S"," "," "," "	 
...
loadKD:			mov		r0,#diap
 ...
 diKDn:	;	db		3fh,50h,6bh,7bh;3fh,80h,00,00		;10-2
		...
		;		db		3fh,51h,2ah,0d9h;3fh,80h,00,00		;10-11
			db		3fh,80h,00,00;3fh,50h,6bh,7bh;3fh,80h,00,00		;10-2
 				db		3fh,80h,00,00;3fh,50h,7fh,0cch;3fh,80h,00,00		;10-3
				db		3fh,80h,00,00;3fh,4fh,9dh,0bh;3fh,80h,00,00		;10-4
 				db		3fh,80h,00,00;3fh,4fh,0e8h,69h;3fh,80h,00,00		;10-5
 				db		3fh,80h,00,00;3fh,50h,29h,4ah;3fh,80h,00,00;4fh,0e9h,11h	;0,81215   10-6
 				 db		3fh,80h,00,00;3fh,50h,63h,9eh;3fh,80h,00,00		;10-7
 				db		3fh,80h,00,00;3fh,4bh,0c9h,0f0h;3fh,80h,00,00		;10-8
				db		3fh,80h,00,00;3fh,4ch,06h,3bh;3fh,80h,00,00		;10-9
 				db		3fh,80h,00,00;3fh,50h,0efh,0ddh;3fh,80h,00,00		;10-10
				db		3fh,80h,00,00
