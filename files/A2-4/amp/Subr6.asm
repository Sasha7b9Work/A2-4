...
tabB1_2:		db		00,00		 ;B1,B2 в соотв с Tизм  
				...
				db		60h,00h;40h,04h		;0,1s
				db		60h,00h;20h,04h		;50ms
				db		60h,00h;20h,04h		 ;10ms
				db		13h,32h		;2ms
...
;bufind+10.0->makoi.7 такт
;bufind+10.1->makoi+1.7 измер
;bufind+10.2->makoi+2.7 avp
;bufind+10.3->makoi+3.7 нуль
;bufind+10.4->makoi+4.7 0,1s
;bufind+10.5->makoi+5.7 1s
;bufind+10.6->makoi+6.7 10s
;bufind+10.7->makoi+7.7 кмп
;bufind+11.0->makoi+8.7 память
;bufind+11.1->makoi+9.7 пуск
;знакоместа 0..9(10 знакомест)
;bufind+11.2->точка после 5 знакоместа
;bufind+11.3->точка после 8 знакоместа
;bufind+11.4->точка после 1 знакоместа(+0,0000  -7a)
;bufind+11.5->точка после 7 знакоместа
;bufind+11.6->точка после 6 знакоместа
;bufind+11.7->точка после 4 знакоместа

;ERR ошибки
;ERR 2-пароль в калибровке не соответствует
;ERR 3-не проходит тест RS
;ERR 4-в режиме R не введена константа U=0000(=0)