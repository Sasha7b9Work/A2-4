...
volume		data	0d5h;объем блока
chblok		data	0d6h;volume;кол измерений блока
copy_hl		data  0d7h;копия адреса последней записанной ячейки блока saven_bl
;data		0d9h
...
nobuf:		call	ind	   ;пп выдачи на индикатор
norvich: 
     				mov		r0,# parT
					mov		r1,#chind
					cjne	@r0,#1,rnot1in
...
govvlist:			cjne		@r0,#42h,rlist_43
				...
				pop			rr3
				pop			rr2
				mov			r1,#saven_bl+1;сохр адрес внешн озу введенного элемента
				mov			a,dpl
				add			a,r5
				mov			dpl,a
				mov			@r1,a		;low
...
list_43:		cjne	@r0,#43h,noli_43
						...
						mov		r0,#marker
						mov		@r0,#0ffh
						jmp		label7;по кн <- выход из просмотра
...
meng:			call		adrblok;dptr-адр ячейки 1й соотв блока 
					...
					;;;;;;;;
					  ...
					  mov		@r1,a
						...
						;;;;;;;;;;;		
nextmea:		movx		a,@dptr		;из яч внешн озу ->r2..r5
					mov			r2,a
					inc			dptr
					movx		a,@dptr
					mov			r3,a
