...
vvchibl:	;mov			r0,#level
					;cjne		@r0,#32h,vvchibl4;при наборе цифр в блоке
					jmp			vvchif	;при наборе цифр в интервале					
vvchibl4:
  			clr		bitmig
				mov		r1,#marker
				mov		a,@r1			;изм цифры
...
teCH:		db	30h,'T',79h,34h,"E",'T'," ",30h,30h,30h;ОТСЧЕТ 000
