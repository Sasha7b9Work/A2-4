...
;;выдача в RS измерений в формате плав. точки 
...
;;команды RS  со 2-м байтом в ASCII (непроверенно) 25.11.09
