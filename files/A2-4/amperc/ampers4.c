...
//	wriacp=int atoi(const char*rezacp);
//	ddd=0x2ff;
//	ccc=0x345;
//buffer[0]=0x30;
	//for	(j=0;j<10;j++){
//	sprintf(buffer,"/%d",lll);
//	}
...
//a=0xffff;
//n=sprintf(buffer,"%*d",a);виснет пп

//a=255;
//n=sprintf(buffer,"%u",a);

k=0x007ffe;
n=sprintf(buffer,"%*d",k);
...
//							result=bufIn[0];
//							result=result<<24;
//							result1+=result;				//счет числа импульсов
//							result=bufIn[1];
//							result=result<<16;
//							result1+=result;
//							result=bufIn[2];
...
//							result2=0;
//							result=(unsigned long)bufIn[4];		
//							result=result<<24;
//							result2+=result;				//частота
//							result=(unsigned long)bufIn[5];
//							result=result<<16;
//							result2+=result;
//							result=(unsigned long)bufIn[6];
//							result=result<<8;
//							result2+=result;
//							result=(unsigned long)bufIn[7];
//							result2+=result;
//							result1==result1/result2;
//							dbufIn=(double)result1*0.001;
//							strResult.Format(" %.0f                  ",dbufIn);
						}