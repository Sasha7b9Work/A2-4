...
//XRAM внешнее озу
	 ...
	 float   xdata MASS[2];//[2]//_at_ 0x0003;
...
//char pdata pass1 _at_ 0x00;
 ...
 //char xdata mass[1]_at_ 0x000b;
// char xdata bass[1]_at_ 0x000c;
// xdata int begx[1]_at_ 0x0000;
//
//-----------------------------------------------------------------------------
// Function PROTOTYPES
//-----------------------------------------------------------------------------
...
//	rez=rez*3;
//	rez=rez*0.1;
// скользящий массив из 2х значений
...
//d7
	portwri=0;
	BIT7p1=1;
	Rdat=wriacp;//portwri=portwri|wriacp;
	wriacp=wriacp<<1;
	tim2();
	BIT7p1=0;
	tim2();
